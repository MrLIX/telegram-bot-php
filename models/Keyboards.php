...
class Keyboards extends ActiveRecord
{
    ...
    public function AllKeyboards($message)
    {
        ...
        $contact = [
            [
                "text" => $message->getContact(),
                "method" => "sendPhoneNumber"
            ],
            [
                "text" => $message->getLocation(),
                "method" => "saveOrder"
            ],
